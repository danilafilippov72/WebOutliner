...
export class InformationBox {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(InformationBox.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (InformationBox.Form.Image.Text != null) object.appendChild(document.createTextNode(InformationBox.Form.Image.Text));
            Object.values(InformationBox.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as InformationBox).Methods.Create());
            });
    ...
    public static Elements = class Elements {
        public static CurrentMethodText = CurrentMethodText;
        public static CurrentMethod = CurrentMethod;
        public static OtherMethodsText = OtherMethodsText;
    ...
    public Image = InformationBox.Form;
    public Methods = InformationBox.Methods;
    public Elements = InformationBox.Elements;
    public References = InformationBox.References;
    //#endregion
    //#endregion Hidden
}