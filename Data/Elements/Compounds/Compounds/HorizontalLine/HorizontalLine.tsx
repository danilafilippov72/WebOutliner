...
export class HorizontalLine {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(HorizontalLine.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };

        public static async Create(): Promise<HTMLDivElement> {
            if (HorizontalLine.InstanceIdentificator == null) HorizontalLine.InstanceIdentificator = count.toString();
            ...
            if (HorizontalLine.Form.Image.Text != null) object.appendChild(document.createTextNode(HorizontalLine.Form.Image.Text));
            Object.values(HorizontalLine.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as HorizontalLine).Methods.Create());
            });
    ...
    public Image = HorizontalLine.Form;
    public Methods = HorizontalLine.Methods;
    public Elements = HorizontalLine.Elements;
    public References = HorizontalLine.References;
    //#endregion
    //#endregion Hidden
}