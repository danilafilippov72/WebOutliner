export class InformationBoxText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "InformationBoxText";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(InformationBoxText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (InformationBoxText.Form.Image?.Text != null) object.appendChild(document.createTextNode(InformationBoxText.Form.Image.Text));
            Object.values(InformationBoxText.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as InformationBoxText).Methods.Create());
            });
    ...
    public Image = InformationBoxText.Form;
    public Methods = InformationBoxText.Methods;
    public Elements = InformationBoxText.Elements;
    public References = InformationBoxText.References;
    //#endregion
    //#endregion Hidden
}