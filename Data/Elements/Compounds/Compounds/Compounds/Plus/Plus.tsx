...
export class Plus {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(Plus.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };

        public static async Create(): Promise<HTMLDivElement> {
            if (Plus.InstanceIdentificator == null) Plus.InstanceIdentificator = count.toString();
            ...
            if (Plus.Form.Image.Text != null) object.appendChild(document.createTextNode(Plus.Form.Image.Text));
            Object.values(Plus.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as Plus).Methods.Create());
            });
    ...
    public Image = Plus.Form;
    public Methods = Plus.Methods;
    public Elements = Plus.Elements;
    public References = Plus.References;
    //#endregion
    //#endregion Hidden
}