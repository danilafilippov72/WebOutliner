export class ObjectReferenceHandlerText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "ObjectReferenceHandler";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ObjectReferenceHandlerText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ObjectReferenceHandlerText.Form.Image?.Text != null) object.appendChild(document.createTextNode(ObjectReferenceHandlerText.Form.Image.Text));
            Object.values(ObjectReferenceHandlerText.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ObjectReferenceHandlerText).Methods.Create());
            });
    ...
    public Image = ObjectReferenceHandlerText.Form;
    public Methods = ObjectReferenceHandlerText.Methods;
    public Elements = ObjectReferenceHandlerText.Elements;
    public References = ObjectReferenceHandlerText.References;
    //#endregion
    //#endregion Hidden
}