...
export class ElementWidthRight {
        ...
        public static Image = class Image {
            ...
            public static positionOffset: {
                ...
                top: number | string;
                    ...
                    left: Image.Border.width as number / 2,
                    top: 0
                };
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                object.Form.Image.gridColumnsWidth[4] = (-(Properties.Coordinates.x - imageObject.getBoundingClientRect().right) / imageObject.clientWidth * 100).toString() + "%";
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ElementWidthRight.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };

        public static async Create(): Promise<HTMLDivElement> {
            if (ElementWidthRight.InstanceIdentificator == null) ElementWidthRight.InstanceIdentificator = count.toString();
            ...
            if (ElementWidthRight.Form.Image.Text != null) object.appendChild(document.createTextNode(ElementWidthRight.Form.Image.Text));
            Object.values(ElementWidthRight.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ElementWidthRight).Methods.Create());
            });
    ...
    public Image = ElementWidthRight.Form;
    public Methods = ElementWidthRight.Methods;
    public Elements = ElementWidthRight.Elements;
    public References = ElementWidthRight.References;
    //#endregion
    //#endregion Hidden
}