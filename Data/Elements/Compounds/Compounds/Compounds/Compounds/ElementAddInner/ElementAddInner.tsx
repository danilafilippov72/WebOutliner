...
import { ElementCreator } from "../Compounds/ElementCreator/ElementCreator";
import { OtherMethods } from "../Compounds/OtherMethods/OtherMethods";

export class ElementAddInner {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                object.Form.Image.gridRowsWidth[0] += - (global.Coordinates.y - Properties.Coordinates.y)/*  * (0.01 * Math.abs(global.Coordinates.x - Properties.Coordinates.x)) */;
                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        async function (Identificator, Properties) {
                            ...
                            imageObject.appendChild(await ElementCreator.Methods.Create());
                        }
                    ];
                }
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ElementAddInner.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };

        public static async Create(): Promise<HTMLDivElement> {
            if (ElementAddInner.InstanceIdentificator == null) ElementAddInner.InstanceIdentificator = count.toString();
            ...
            if (ElementAddInner.Form.Image.Text != null) object.appendChild(document.createTextNode(ElementAddInner.Form.Image.Text));
            Object.values(ElementAddInner.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ElementAddInner).Methods.Create());
            });
    ...
    public Image = ElementAddInner.Form;
    public Methods = ElementAddInner.Methods;
    public Elements = ElementAddInner.Elements;
    public References = ElementAddInner.References;
    //#endregion
    //#endregion Hidden
}