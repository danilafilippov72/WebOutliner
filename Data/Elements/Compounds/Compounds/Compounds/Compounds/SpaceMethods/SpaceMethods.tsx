...
export class SpaceMethods {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplateColumns: string = "20% 80%";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(SpaceMethods.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (SpaceMethods.InstanceIdentificator == null) SpaceMethods.InstanceIdentificator = count.toString();
            ...
            if (SpaceMethods.Form.Image.Text != null) object.appendChild(document.createTextNode(SpaceMethods.Form.Image.Text));

            Object.values(SpaceMethods.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as SpaceMethods).Methods.Create());
            });
    ...
    public static Elements = class Elements {
        public static AdddMethod = AdddMethod;
        public static AddAnimationMethod = AddAnimationMethod;
    }
    ...
    public Image = SpaceMethods.Form;
    public Methods = SpaceMethods.Methods;
    public Elements = SpaceMethods.Elements;
    public References = SpaceMethods.References;
    //#endregion
    //#endregion Hidden
}
