...
import { AdddMethod } from "../../AddMethod/AddMethod";
...
export class Method {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "Method!";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(Method.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (Method.Form.Image.Text != null) object.appendChild(document.createTextNode(Method.Form.Image.Text));
            Object.values(Method.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as Method).Methods.Create());
            });
    ...
    public Image = Method.Form;
    public Methods = Method.Methods;
    public Elements = Method.Elements;
    public References = Method.References;
    //#endregion
    //#endregion Hidden
}
