...
export class ObjectReferenceHandlersNode {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = '"a b b" fit-content(1px) "q c d" 1fr /  30px 30px 1fr';
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ObjectReferenceHandlersNode.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ObjectReferenceHandlersNode.Form.Image.Text != null) object.appendChild(document.createTextNode(ObjectReferenceHandlersNode.Form.Image.Text));
            Object.values(ObjectReferenceHandlersNode.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ObjectReferenceHandlersNode).Methods.Create());
            });
    ...
    public static Elements = class Elements {
        ...
        public static ObjectReferenceHandlerText = ObjectReferenceHandlerText;
        public static InformationNode = InformationNode;
    }
    ...
    public Image = ObjectReferenceHandlersNode.Form;
    public Methods = ObjectReferenceHandlersNode.Methods;
    public Elements = ObjectReferenceHandlersNode.Elements;
    public References = ObjectReferenceHandlersNode.References;
    //#endregion
    //#endregion Hidden
}