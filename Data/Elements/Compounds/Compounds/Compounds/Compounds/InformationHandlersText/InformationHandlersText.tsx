export class InformationHandlersText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "Information Handlers";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(InformationHandlersText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (InformationHandlersText.InstanceIdentificator == null) InformationHandlersText.InstanceIdentificator = count.toString();
            ...
            if (InformationHandlersText.Form.Image.Text != null) object.appendChild(document.createTextNode(InformationHandlersText.Form.Image.Text));

            Object.values(InformationHandlersText.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as InformationHandlersText).Methods.Create());
            });
    ...
    public Image = InformationHandlersText.Form;
    public Methods = InformationHandlersText.Methods;
    public Elements = InformationHandlersText.Elements;
    public References = InformationHandlersText.References;
    //#endregion
    //#endregion Hidden
}