import { ElementAddInner } from "../../ElementAddInner/ElementAddInner";
...
import { ElementWidthRight } from "../../ElementWidthRight/ElementWidthRight";
...
export class ElementCreator {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridColumnsWidth: [...any] = ["0%", "auto", "auto", "auto", "0%"];

            public static gridTemplateColumns: string /* = "1fr 1fr" */;
            public static gridArea: any /* = [2, 2, 2, 6]; */ = "e";/* ;2 / 1 / 2/ 6 */
  ...
  */
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            Object.values(ElementCreator.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ElementCreator).Methods.Create());
            });
    ...
    public static Elements = class Elements {
        public static ElementWidthRight = ElementWidthRight;
        ...
        public static ElementAddInner = ElementAddInner;
