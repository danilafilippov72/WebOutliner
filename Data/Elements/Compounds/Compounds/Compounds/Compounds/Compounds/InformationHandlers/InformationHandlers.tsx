...
export class InformationHandlers {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = '"b b" fit-content(1px) "c d" 1fr / 30px 1fr';
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(InformationHandlers.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (InformationHandlers.InstanceIdentificator == null) InformationHandlers.InstanceIdentificator = count.toString();
            ...
            if (InformationHandlers.Form.Image.Text != null) object.appendChild(document.createTextNode(InformationHandlers.Form.Image.Text));

            Object.values(InformationHandlers.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as InformationHandlers).Methods.Create());
            });
    ...
    public Image = InformationHandlers.Form;
    public Methods = InformationHandlers.Methods;
    public Elements = InformationHandlers.Elements;
    public References = InformationHandlers.References;
    //#endregion
    //#endregion Hidden
}