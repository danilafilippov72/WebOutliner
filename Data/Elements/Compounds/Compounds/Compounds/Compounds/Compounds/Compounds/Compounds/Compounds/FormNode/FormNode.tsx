...
export class FormNode {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(FormNode.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (FormNode.InstanceIdentificator == null) FormNode.InstanceIdentificator = count.toString();
            ...
            if (FormNode.Form.Image.Text != null) object.appendChild(document.createTextNode(FormNode.Form.Image.Text));

            Object.values(FormNode.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as FormNode).Methods.Create());
            });
    ...
    public Image = FormNode.Form;
    public Methods = FormNode.Methods;
    public Elements = FormNode.Elements;
    public References = FormNode.References;
    //#endregion
    //#endregion Hidden
}
