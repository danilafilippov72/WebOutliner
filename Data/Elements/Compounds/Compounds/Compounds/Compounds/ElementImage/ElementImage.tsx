export class ElementImage {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ElementImage.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ElementImage.Form.Image.Text != null) object.appendChild(document.createTextNode(ElementImage.Form.Image.Text));
            Object.values(ElementImage.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ElementImage).Methods.Create());
            });
    ...
    public Image = ElementImage.Form;
    public Methods = ElementImage.Methods;
    public Elements = ElementImage.Elements;
    public References = ElementImage.References;
    //#endregion
    //#endregion Hidden
}