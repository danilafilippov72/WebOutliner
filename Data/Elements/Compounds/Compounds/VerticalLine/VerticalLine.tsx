...
export class VerticalLine {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(VerticalLine.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };

        public static async Create(): Promise<HTMLDivElement> {
            if (VerticalLine.InstanceIdentificator == null) VerticalLine.InstanceIdentificator = count.toString();
            ...
            if (VerticalLine.Form.Image.Text != null) object.appendChild(document.createTextNode(VerticalLine.Form.Image.Text));
            Object.values(VerticalLine.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as VerticalLine).Methods.Create());
            });
    ...
    public Image = VerticalLine.Form;
    public Methods = VerticalLine.Methods;
    public Elements = VerticalLine.Elements;
    public References = VerticalLine.References;
    //#endregion
    //#endregion Hidden
}