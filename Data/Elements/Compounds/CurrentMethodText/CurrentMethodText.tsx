export class CurrentMethodText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "CurrentMethod";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(CurrentMethodText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (CurrentMethodText.Form.Image.Text != null) object.appendChild(document.createTextNode(CurrentMethodText.Form.Image.Text));
            Object.values(CurrentMethodText.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as CurrentMethodText).Methods.Create());
            });
    ...
    public Image = CurrentMethodText.Form;
    public Methods = CurrentMethodText.Methods;
    public Elements = CurrentMethodText.Elements;
    public References = CurrentMethodText.References;
    //#endregion
    //#endregion Hidden
}