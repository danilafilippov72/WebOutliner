...
export class CurrentMethod {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(CurrentMethod.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (CurrentMethod.Form.Image.Text != null) object.appendChild(document.createTextNode(CurrentMethod.Form.Image.Text));
            Object.values(CurrentMethod.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as CurrentMethod).Methods.Create());
            });
    ...
    public Image = CurrentMethod.Form;
    public Methods = CurrentMethod.Methods;
    public Elements = CurrentMethod.Elements;
    public References = CurrentMethod.References;
    //#endregion
    //#endregion Hidden
}