...
export class Style {
    public static ApplyStyles(element: HTMLElement) {
        ...
        if (Style.Border.minWidth) element.style.minWidth =  (typeof Border.minWidth == typeof String ? Border.minWidth as string : (Border.minWidth + "px")) + ";" : "") +
        if (Style.Border.maxWidth) element.style.maxWidth = (typeof Border.maxWidth == typeof String ? Border.maxWidth as string : (Border.maxWidth + "px")) + ";" : "") +
        if (Style.Border.height) element.style.height =  (typeof Border.height == typeof String ? Border.height as string : (Border.height + "px")) + ";" : "") +
        if (Style.Border.minHeight) element.style.minHeight =  (typeof Border.minHeight == typeof String ? Border.minHeight as string : (Border.minHeight + "px")) + ";" : "") +
        if (Style.Border.maxHeight) element.style.maxHeight = (typeof Border.maxHeight == typeof String ? Border.maxHeight as string : (Border.maxHeight + "px")) + ";" : "") +
