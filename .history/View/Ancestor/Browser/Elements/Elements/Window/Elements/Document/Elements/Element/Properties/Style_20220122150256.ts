...
export class Style {
    public static ApplyStyles(element: HTMLElement) {
        ...
        if (Style.Border.minWidth) element.style.minWidth =  (typeof StylBorder.minWidth == typeof String ? StylBorder.minWidth as string : (Border.minWidth + "px")) + ";" : "") +
        if (Style.Border.maxWidth) element.style.maxWidth = (typeof StylBorder.maxWidth == typeof String ? StylBorder.maxWidth as string : (Border.maxWidth + "px")) + ";" : "") +
        if (Style.Border.height) element.style.height =  (typeof StylBorder.height == typeof String ? StylBorder.height as string : (Border.height + "px")) + ";" : "") +
        if (Style.Border.minHeight) element.style.minHeight =  (typeof StylBorder.minHeight == typeof String ? StylBorder.minHeight as string : (Border.minHeight + "px")) + ";" : "") +
        if (Style.Border.maxHeight) element.style.maxHeight = (typeof StylBorder.maxHeight == typeof String ? StylBorder.maxHeight as string : (Border.maxHeight + "px")) + ";" : "") +
