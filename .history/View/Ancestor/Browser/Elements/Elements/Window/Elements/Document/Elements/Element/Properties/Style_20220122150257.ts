...
export class Style {
    public static ApplyStyles(element: HTMLElement) {
        ...
        if (Style.Border.minWidth) element.style.minWidth =  (typeof Style.Border.minWidth == typeof String ? Style.Border.minWidth as string : (Border.minWidth + "px")) + ";" : "") +
        if (Style.Border.maxWidth) element.style.maxWidth = (typeof Style.Border.maxWidth == typeof String ? Style.Border.maxWidth as string : (Border.maxWidth + "px")) + ";" : "") +
        if (Style.Border.height) element.style.height =  (typeof Style.Border.height == typeof String ? Style.Border.height as string : (Border.height + "px")) + ";" : "") +
        if (Style.Border.minHeight) element.style.minHeight =  (typeof Style.Border.minHeight == typeof String ? Style.Border.minHeight as string : (Border.minHeight + "px")) + ";" : "") +
        if (Style.Border.maxHeight) element.style.maxHeight = (typeof Style.Border.maxHeight == typeof String ? Style.Border.maxHeight as string : (Border.maxHeight + "px")) + ";" : "") +
