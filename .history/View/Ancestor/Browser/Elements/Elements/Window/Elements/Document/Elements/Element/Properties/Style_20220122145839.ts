...
export class Style {
    public static ApplyStyles(element: HTMLElement) {
        ...
        if (Style.Border.minWidth)  (typeof Border.minWidth == typeof String ? Border.minWidth as string : (Border.minWidth + "px")) + ";" : "") +
        if (Style.Border.maxWidth) (typeof Border.maxWidth == typeof String ? Border.maxWidth as string : (Border.maxWidth + "px")) + ";" : "") +
        if (Style.Border.height)  (typeof Border.height == typeof String ? Border.height as string : (Border.height + "px")) + ";" : "") +
        if (Style.Border.minHeight) (Border.minHeight ? "max=height: " + (typeof Border.minHeight == typeof String ? Border.minHeight as string : (Border.minHeight + "px")) + ";" : "") +
        if (Style.Border.maxHeight) (Border.maxHeight ? "max=height: " + (typeof Border.maxHeight == typeof String ? Border.maxHeight as string : (Border.maxHeight + "px")) + ";" : "") +
        if (Style.Border.borderWidth) (Border.borderWidth ? "border-width: " + Border.borderWidth + "px" + ";" : "") +
        if (Style.Border.borderType) (Border.borderType ? "border-style: " + Border.borderType as string + ";" : "") +
        if (Style.Border.borderRadius) (Border.borderRadius ? "border-radius: " + Border.borderRadius + "px" + ";" : "") +
        if (Style.Border.borderColor) (Border.borderColor ? "border-color: " + Border.borderRadius + ";" : "") +
        if (Style.Border.backgroundColor) (Border.backgroundColor ? "background-color: " + Border.backgroundColor + ";" : "") +
        if (Style.Border.padding) (Border.padding ? "padding: " + Border.padding + "px" + ";" : "")
        return element;
    }
