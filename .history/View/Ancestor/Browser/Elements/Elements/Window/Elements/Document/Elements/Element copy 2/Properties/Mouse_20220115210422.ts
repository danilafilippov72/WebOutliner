...
export class Mouse {
    ...
    public static async Initialize() {
        ...
        class GlobalMouseEvent {
            ...
            static onEvent(event: Event, mouseEvent: typeof GlobalMouseEvent.eventTypes[keyof typeof GlobalMouseEvent.eventTypes] typesOf<typeof GlobalMouseEvent.eventTypes>) {
