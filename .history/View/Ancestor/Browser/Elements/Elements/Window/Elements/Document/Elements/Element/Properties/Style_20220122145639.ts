...
export class Style {
    public static ApplyStyles(element: HTMLElement) {
        ...
        if (Style.Border.Margin) (Border.width ? "width: " + (typeof Border.width == typeof String ? Border.width as string : (Border.width + "px")) + ";" : "") +
        if (Style.Border.Margin) (Border.minWidth ? "max-width: " + (typeof Border.minWidth == typeof String ? Border.minWidth as string : (Border.minWidth + "px")) + ";" : "") +
        if (Style.Border.Margin) (Border.maxWidth ? "max-width: " + (typeof Border.maxWidth == typeof String ? Border.maxWidth as string : (Border.maxWidth + "px")) + ";" : "") +
        if (Style.Border.Margin) (Border.height ? "height: " + (typeof Border.height == typeof String ? Border.height as string : (Border.height + "px")) + ";" : "") +
