...
export class OtherMethodsText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "OtherMethodsText";
    ...
    public static Methods = class Methods {
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            object.setAttribute("Identificator", OtherMethodsText.Identificator);
            ...
            Object.values(OtherMethodsText.Elements).forEach(childElement => object.appendChild((childElement as OtherMethodsText).Methods.Create()));
