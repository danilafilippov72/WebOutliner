...
export class OtherMethodsText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "OtherMethods";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(OtherMethodsText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (OtherMethodsText.Form.Image.Text != null) object.appendChild(document.createTextNode(OtherMethodsText.Form.Image.Text));
            Object.values(OtherMethodsText.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as OtherMethodsText).Methods.Create()));
    ...
    public Image = OtherMethodsText.Form;
    public Methods = OtherMethodsText.Methods;
    public Elements = OtherMethodsText.Elements;
    public References = OtherMethodsText.References;
    //#endregion
    //#endregion Hidden
}