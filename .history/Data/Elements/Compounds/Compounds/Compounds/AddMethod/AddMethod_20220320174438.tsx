    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                console.log('1');
                if (InformationHandler.) document.querySelector('[identificator="' + AdddMethod.Identificator + '"]').addEventListener("Outline", function (event: CustomEvent) { InformationHandler.Initialize(event.detail) });
