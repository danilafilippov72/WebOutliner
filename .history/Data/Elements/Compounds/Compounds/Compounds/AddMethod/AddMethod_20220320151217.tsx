    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                console.log(AdddMethod.Identificator);
                document.getElementById(AdddMethod.Identificator.toString()).addEventListener("Outline", function (event: CustomEvent) { console.log(event.detail); InformationHandler.Initialize(event.detail) }, false);
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            Object.values(AdddMethod.Elements).forEach(childElement => {
                const t = (childElement as AdddMethod).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
