...
export class InformationHandlersTextAdddMethod {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        function () {
                            ...
                            globalThis.count += 1
                            document.querySelector('[identificator="' + AdddMethod.Identificator + '"]').parentElement.append(Method.Methods.Create(globalThis.count)[0])
                        }
                    ];
                }
            ...
            public static ExtensionLackListeners() {
                if (InformationHandler.isListener == false) {
                    document.querySelectorAll('[instanceidentificator="' + AdddMethod.Identificator + '"]')
        ...
        public static async Create(count: number): Promise<[HTMLDivElement, number]> {
            var count = count;
            InformationHandlersText.Identificator = count.toString();
            ...
            const array = Object.values(InformationHandlersText.Elements);
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                const t = await (childElement as InformationHandlersText).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
