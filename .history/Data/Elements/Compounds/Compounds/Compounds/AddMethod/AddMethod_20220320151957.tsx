    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                document.getElementsByTagName(AdddMethod.Identificator).addEventListener("Outline", function (event: CustomEvent) { console.log(event.detail); InformationHandler.Initialize(event.detail) }, false);
