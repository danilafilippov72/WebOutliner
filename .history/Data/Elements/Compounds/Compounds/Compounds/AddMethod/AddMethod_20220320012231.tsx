    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                document.getElementById("AddMethod")
                document.body.addEventListener("Outline", function (event: CustomEvent) { console.log(event.detail); InformationHandler.Initialize(event.detail) }, false);
        ...
        public static Create(count) {
            ...
            Object.values(AdddMethod.Elements).forEach(childElement =>.childElement.M
            object.setAttribute("Identificator", AdddMethod.Identificator);
           ...
           /*  var count */
            Object.values(AdddMethod.Elements).forEach(childElement => {
                const child, countAdd = (childElement as AdddMethod).Methods.Create(count)
                count += countAdd object.appendChild()
            }
            );
