    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                console.log(AdddMethod.Identificator, document.getElementById(AdddMethod.Identificator.toString()));
                document.get("Identificator", (AdddMethod.Identificator).addEventListener("Outline", function (event: CustomEvent) { console.log(event.detail); InformationHandler.Initialize(event.detail) }, false);
