...
export class AdddMethod {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        async function () {
                            ...
                            globalThis.count += 1
                            document.querySelector('[identificator="' + AdddMethod.Identificator + '"]').parentElement.append((await Method.Methods.Create(global.count))[0])
                        }
                    ];
                }
            ...
            public static ExtensionLackListeners() {
                if (InformationHandler.isListener == false) {
                    document.querySelectorAll('[identificator="' + AdddMethod.Identificator + '"]')
        ...
        public static async Create(): Promise<[HTMLDivElement]> {
            ...
            if (AdddMethod.InstanceIdentificator == null) AdddMethod.InstanceIdentificator = global.count.toString();
            //#region ExtensionInterface
            let object = document.createElement("div");
            ...
            const array = Object.values(AdddMethod.Elements).forEach(childElement => object.appendChild(await (childElement as AdddMethod).Methods.Create());
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                ;
            }
