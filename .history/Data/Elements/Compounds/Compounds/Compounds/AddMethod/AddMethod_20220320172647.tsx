    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                console.log('tat', document.querySelector('[Identificator="' + AdddMethod.Identificator + '"]'));
                document.querySelector('[identificator="' + AdddMethod.Identificator + '"]').addEventListener("Outline", function (event: CustomEvent) { console.log('1wefsdfsdf', event.detail); InformationHandler.Initialize(event.detail) }, false);
