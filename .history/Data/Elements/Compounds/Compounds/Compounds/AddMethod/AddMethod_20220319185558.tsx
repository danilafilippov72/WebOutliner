export class AddM {
    ...
    public static Methods = class Methods {
        ...
        public static Create() {
            ...
            object.setAttribute("Identificator", AddM.Identificator);
            object.setAttribute("InstanceIdentificator", AddM.InstanceIdentificator);
            object = AddM.Form.Image.ApplyImage(object);
            if (AddM.Form.Image.Text != null) object.appendChild(document.createTextNode(AddM.Form.Image.Text));
            Object.values(AddM.Elements).forEach(childElement => object.appendChild((childElement as AddM).Methods.Create()));
    ...
    public Image = AddM.Form;
    public Methods = AddM.Methods;
    public Elements = AddM.Elements;
    public References = AddM.References;
    //#endregion
    //#endregion Hidden
}