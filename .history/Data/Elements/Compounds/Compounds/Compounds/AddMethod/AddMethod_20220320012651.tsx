export class AdddMethod {
    ...
    public static Methods = class Methods {
        ...
        public static Create(count): [HTMLDivElement, number] {
            //#region ExtensionInterface
            let object = document.createElement("div");
            object.setAttribute("Identificator", toString(count));
            ...
            Object.values(AdddMethod.Elements).forEach(childElement => {
                const tw = (childElement as AdddMethod).Methods.Create(count);
                const child, countAdd = tw[0], tw[1];
