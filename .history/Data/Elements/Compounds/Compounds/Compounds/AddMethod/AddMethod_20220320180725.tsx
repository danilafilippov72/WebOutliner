export class AdddMethod {
    ...
    public static Methods = class Methods {
            ...
            public static ExtensionLackListeners() {
                if (InformationHandler.isListener == false) {
                    document.querySelectorAll('[identificator="' + AdddMethod.Identificator + '"]')
                        .forEach(element => element.addEventListener("Outline", function (event: CustomEvent) { InformationHandler.Initialize(event.detail) }));
        ...
        public static async Create(count: number): Promise<[HTMLDivElement, number]> {
            ...
            if (AdddMethod.Identificator == null) {
