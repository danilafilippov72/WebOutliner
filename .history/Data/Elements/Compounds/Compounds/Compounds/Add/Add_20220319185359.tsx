export class Add {
    ...
    public static Methods = class Methods {
        ...
        public static Create() {
            ...
            object.setAttribute("Identificator", Add.Identificator);
            object.setAttribute("InstanceIdentificator", Add.InstanceIdentificator);
            object = Add.Form.Image.ApplyImage(object);
            if (Add.Form.Image.Text != null) object.appendChild(document.createTextNode(Add.Form.Image.Text));
            Object.values(Add.Elements).forEach(childElement => object.appendChild((childElement as Add).Methods.Create()));
    ...
    public Image = Add.Form;
    public Methods = Add.Methods;
    public Elements = Add.Elements;
    public References = Add.References;
    //#endregion
    //#endregion Hidden
}