...
export class FormBox {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(FormBox.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (FormBox.InstanceIdentificator == null) FormBox.InstanceIdentificator = count.toString();
            ...
            if (FormBox.Form.Image.Text != null) object.appendChild(document.createTextNode(FormBox.Form.Image.Text));

            Object.values(FormBox.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as FormBox).Methods.Create()));
    ...
    public static Elements = class Elements {
        public static WindowForm = WindowForm;
    }
    ...
    public Image = FormBox.Form;
    public Methods = FormBox.Methods;
    public Elements = FormBox.Elements;
    public References = FormBox.References;
    //#endregion
    //#endregion Hidden
}