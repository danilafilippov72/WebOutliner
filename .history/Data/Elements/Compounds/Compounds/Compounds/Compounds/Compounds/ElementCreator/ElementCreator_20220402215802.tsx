...
export class ElementCreator {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = ["a b b b c",  "d e e e f", "d g h i f", "d j j j f", "k l l l m"];
            public static gridRowsWidth: [...any] = [0, "auto", "auto", "auto", "auto"];
            public static gridColumnsWidth: [...any] = ["auto", "auto", "auto", "auto", "auto", "auto"];;
            ...
            public static ApplyImage(element: HTMLDivElement) {
                ...
                if (Image?.gridTemplate != null) {
                    var gridTemplate = 
                    element.style.gridTemplate = Image.gridTemplate.fo;
                }
