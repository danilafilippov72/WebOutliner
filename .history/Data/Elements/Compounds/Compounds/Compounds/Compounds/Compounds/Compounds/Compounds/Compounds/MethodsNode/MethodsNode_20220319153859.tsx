export class MethodsNode {
    ...
    public static Methods = class Methods {
        ...
        public static Create() {
            ...
            object.setAttribute("Identificator", MethodsNode.Identificator);
            ...
            Object.values(MethodsNode.Elements).forEach(childElement => object.appendChild((childElement as MethodsNode).Methods.Create()));
    ...
    public static Elements = class Elements {
        public static ObjectMethodText = ObjectMethodsText;
        public static ObjectMethodBox = ObjectMethodBox;
    }

    public static References = class References { }

    public static Identificator: string = MethodsNode.name;
