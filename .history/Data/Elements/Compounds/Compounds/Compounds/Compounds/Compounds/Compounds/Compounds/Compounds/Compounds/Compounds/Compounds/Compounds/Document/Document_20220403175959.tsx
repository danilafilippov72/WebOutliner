        ...
        public static InformationHandler = class InformationHandler {
                    ...
                    private static OtherMethods: Function[] = [
                        ...
                        function (event: MouseEvent, Identificator) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                var object = globalThis.search.FindObjectByIdentificator(imageObject.getAttribute("identificator"), Document) as unknown as typeof Document;

                                object.Form.Image.gridRowsWidth[0] += - (global.Coordinates.y - event.y);
                                ...
                                if (object.Form.Image?.gridTemplate != null) {
                                    ...
                                    gridTemplate += " / ";
                                    object.Form.Image.gridColumnsWidth.forEach(col => gridTemplate += col + " ")
            ...
            public static ElementPaddingTop = class ElementPaddingTop {
                ...
                public static MouseCoordinates = class MouseCoordinates {
                    ...
                    private static OtherMethods: Function[] = [
                        function (Coordinates, Identificator) {
                            (global.search.FindObjectByIdentificator(Identificator, Document) as typeof Document).Methods.InformationHandler.Initialize(
                                {
                                    ObjectReference: "MouseHandler",
                                    Identificator: Identificator,
                                    Method: "Move",
                            ...
                            case this.eventTypes.onMouseUp: {
                                switch (this.onMouseUp) {
                                    case this.onMouseTypes.first: {
                                        ...
                                        clearTimeout(this.timeout);
                                        if (Document.Methods.InformationHandler.MouseHandler.Move.CurrentMethod.Response == true) {
                                            Document.Methods.InformationHandler.Initialize({
                                                ObjectReference: "MouseHandler",
                                                Method: "LeftClickHoldingUp",
                                                properties: this.event,
