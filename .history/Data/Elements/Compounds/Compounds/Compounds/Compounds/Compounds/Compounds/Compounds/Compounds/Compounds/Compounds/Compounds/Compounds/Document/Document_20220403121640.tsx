...
export class Doc {
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<HTMLDivElement> {
            Doc.Identificator = global.count.toString();
            if (Doc.InstanceIdentificator == null) Doc.InstanceIdentificator = count.toString();
            //#region ExtensionInterface
            let object = document.createElement("div");

            object.setAttribute("Identificator", global.count.toString());
            object.setAttribute("InstanceIdentificator", Doc.InstanceIdentificator);

            object = Doc.Form.Image.ApplyImage(object);

            if (Doc.Form.Image.Text != null) object.appendChild(document.createTextNode(Doc.Form.Image.Text));

            Object.values(Doc.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof Doc).Identificator = global.count.toString();
                object.appendChild(await (childElement as Doc).Methods.Create())
            });
        ...
        public static async Init() {
            global.count = 1;
            document.body.append(await Doc.Methods.Create());
            ...
            document.body.onmouseenter = (ev) => Doc.Methods.InformationHandler.Initialize({
                ObjectReference: "MouseHandler",
                Method: "HoverIn",
                properties: ev,
            ...
            document.body.onmouseleave = (ev) => Doc.Methods.InformationHandler.Initialize({
                ObjectReference: "MouseHandler",
                Method: "HoverOut",
                properties: ev,
                Identificator: (event.target as HTMLDivElement).getAttribute('identificator')
            ...
            document.body.onmousemove = (ev) => Doc.Methods.InformationHandler.Initialize({
                ObjectReference: "MouseHandler",
                Method: "Move",
                properties: ev,
                Identificator: (event.target as HTMLDivElement).getAttribute('identificator')
            ...
            document.body.onmouseover = (ev) => Doc.Methods.InformationHandler.Initialize({
                ObjectReference: "MouseHandler",
                Method: "HoverOver",
                properties: ev,
                Identificator: (event.target as HTMLDivElement).getAttribute('identificator')
                                ...
                                switch (this.onMouseDown) {
                                    case this.onMouseTypes.first: {
                                        ...
                                        this.setTimeOut(this.event, 200, () => {
                                            ...
                                            Doc.Methods.InformationHandler.Initialize({
                                                ObjectReference: "MouseHandler",
                                                Method: "LeftClickHolding",
            ...
            Doc.Elements.ObjectNode.Methods.InformationHandler.ExtensionLackListeners();
        };
    }
    ...
    public Image = Doc.Form;
    public Methods = Doc.Methods;
    public Elements = Doc.Elements;
    public References = Doc.References;
    //#endregion
    //#endregion Hidden
}
...
declare global {
    ...
    /* class Search{
        public static FindObjectByIdentificator(Identificator) {
            Object.values(Document.Elements).forEach((object, index) => {

                if ((object as typeof Document).Identificator == Identificator)
                    return object
                else if ((object as typeof Document).Identificator < Identificator
                && Identificator < Object.values(Document.Elements)[index + 1] )
