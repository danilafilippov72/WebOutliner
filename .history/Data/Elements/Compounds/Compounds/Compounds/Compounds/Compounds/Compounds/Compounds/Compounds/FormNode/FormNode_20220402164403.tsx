...
export class ImageNode {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = ' "a b" 5% "c d" 1fr / 30px 90% ';
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ImageNode.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            global.count += 1;
            ImageNode.Identificator = global.count.toString();
            if (ImageNode.InstanceIdentificator == null) ImageNode.InstanceIdentificator = count.toString();
            //#region ExtensionInterface
            let object = document.createElement("div");

            object.setAttribute("Identificator", global.count.toString());
            object.setAttribute("InstanceIdentificator", ImageNode.InstanceIdentificator);

            object = ImageNode.Form.Image.ApplyImage(object);

            if (ImageNode.Form.Image.Text != null) object.appendChild(document.createTextNode(ImageNode.Form.Image.Text));

            Object.values(ImageNode.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as ImageNode).Methods.Create()));
    ...
    public Image = ImageNode.Form;
    public Methods = ImageNode.Methods;
    public Elements = ImageNode.Elements;
    public References = ImageNode.References;
    //#endregion
    //#endregion Hidden
}
