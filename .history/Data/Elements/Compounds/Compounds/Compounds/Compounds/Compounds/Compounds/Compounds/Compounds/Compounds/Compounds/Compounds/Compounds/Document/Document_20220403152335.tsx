        ...
        if (Number((object as typeof Document).Identificator) == Number(Identificator)) return object
            ...
            return Search.FindObjectByIdentificator(Identificator, Object.values(object.Elements)
                .find((childObject, index) => {
                    if (Number(Identificator) >= Number((childObject as typeof Document).Identificator
                        && Object.values(object.Elements).length > index + 1
                    && (Object.values(object.Elements)[index + 1] as typeof Document).Identificator > Identificator)
                    ))
        }
           /*  
