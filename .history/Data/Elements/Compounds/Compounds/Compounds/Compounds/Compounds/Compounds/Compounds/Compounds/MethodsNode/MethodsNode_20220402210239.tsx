...
export class MethodsNode {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = ' "a b" auto "c d" auto / 30px auto ';
            public static Display: "none" | "block" | "grid" = "grid";

            public static gridTemplateColumns: string /* = "10% 90%" */;
            public static gridArea: string /* = [1,1] */ = "d";
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (MethodsNode.InstanceIdentificator == null) MethodsNode.InstanceIdentificator = count.toString();
            ...
            Object.values(MethodsNode.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as MethodsNode).Methods.Create()));
