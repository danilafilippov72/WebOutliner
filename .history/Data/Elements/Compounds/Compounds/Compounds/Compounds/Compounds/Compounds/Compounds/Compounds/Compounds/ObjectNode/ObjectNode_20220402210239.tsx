...
export class ObjectNode {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = '"a a" auto "c d" auto "c e" auto / 30px auto';
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ObjectNode.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ObjectNode.InstanceIdentificator == null) ObjectNode.InstanceIdentificator = count.toString();
            ...
            if (ObjectNode.Form.Image.Text != null) object.appendChild(document.createTextNode(ObjectNode.Form.Image.Text));

            Object.values(ObjectNode.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as ObjectNode).Methods.Create()));
    ...
    public static Elements = class Elements {
        public static ObjectNodeText = ObjectNodeText;
        public static OutlineVertical = OutlineVertical;
        public static MethodsNode = MethodsNode;
        public static FormNode = FormNode;
    ...
    public Image = ObjectNode.Form;
    public Methods = ObjectNode.Methods;
    public Elements = ObjectNode.Elements;
    public References = ObjectNode.References;
    //#endregion
    //#endregion Hidden
}