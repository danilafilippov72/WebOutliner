...
export class Outline {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: [...any] = ["a b q", "d c q"];
            public static gridRowsWidth: [...any] = [Outline.Elements.Router.Form.Image.Border.height, "auto"];
            public static gridColumnsWidth: [...any] = ["auto", Outline.Elements.Router.Form.Image.Border.width, "auto"];
