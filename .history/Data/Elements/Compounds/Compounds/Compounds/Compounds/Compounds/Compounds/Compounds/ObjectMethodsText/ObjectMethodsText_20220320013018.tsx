export class ObjectMethodsText {
    ...
    public static Methods = class Methods {
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            object.setAttribute("Identificator", ObjectMethodsText.Identificator);
            ...
            Object.values(ObjectMethodsText.Elements).forEach(childElement => object.appendChild((childElement as ObjectMethodsText).Methods.Create()));
