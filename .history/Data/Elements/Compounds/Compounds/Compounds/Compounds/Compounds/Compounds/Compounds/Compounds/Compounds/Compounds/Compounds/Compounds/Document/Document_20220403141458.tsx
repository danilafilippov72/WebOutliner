...
declare global {
    var count: number;
    class Search{
        public static FindObjectByIdentificator(Identificator, object? = Document) {
            Object.values(object.Elements).forEach((object, index) => {
                ...
                if ((object as typeof Document).Identificator == Identificator)
                    ...
                    return this.FindObjectByIdentificator(Identificator, object)
