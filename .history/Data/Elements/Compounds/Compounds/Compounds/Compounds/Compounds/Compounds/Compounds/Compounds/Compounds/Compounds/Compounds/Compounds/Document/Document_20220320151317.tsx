...
export class Document {
    ...
    public static Methods = class Methods {
        ...
        public static async Create(count: number): [HTMLDivElement, number] {
            ...
            Object.values(Document.Elements).forEach(childElement => {
                const t = (childElement as Document).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
