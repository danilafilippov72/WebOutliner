export class FormText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "Form";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(FormText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (FormText.InstanceIdentificator == null) FormText.InstanceIdentificator = count.toString();
            ...
            if (FormText.Form.Image.Text != null) object.appendChild(document.createTextNode(FormText.Form.Image.Text));

            Object.values(FormText.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as FormText).Methods.Create()));
    ...
    public Image = FormText.Form;
    public Methods = FormText.Methods;
    public Elements = FormText.Elements;
    public References = FormText.References;
    //#endregion
    //#endregion Hidden
}