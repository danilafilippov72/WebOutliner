    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static ApplyImage(element: HTMLDivElement) {
                ...
                if (Image.Border?.maxHeight != null) element.style.maxHeight = Image.Border.boxSizing == typeof String ? Image.Border.boxSizing as string : (Image.Border?.maxHeight + "px"));
