                ...
                public static MouseCoordinates = class MouseCoordinates {
                    ...
                    private static OtherMethods: Function[] = [
                        function (Properties, Identificator) {
                            console.log("MouseCoords", (global.search.FindObjectByIdentificator(global.objectMovement, Document) as typeof Document).Identificator);
                            (global.search.FindObjectByIdentificator(global.objectMovement, Document) as typeof Document).Methods.InformationHandler.Initialize(
                                {
                                    ObjectReference: "MouseHandler",
                                    Identificator: global.objectMovement,
                                    Method: "Move",
