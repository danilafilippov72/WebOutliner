...
export class ObjectMethods {
    ...
    public static Methods = class Methods {
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            object.setAttribute("Identificator", ObjectMethods.Identificator);
            ...
            Object.values(ObjectMethods.Elements).forEach(childElement => object.appendChild((childElement as ObjectMethods).Methods.Create()));
