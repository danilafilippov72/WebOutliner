...
export class ObjectMethodBox {
    ...
    public static Methods = class Methods {
        ...
        public static Create() {
            ...
            object.setAttribute("Identificator", ObjectMethodBox.Identificator);
            ...
            Object.values(ObjectMethodBox.Elements).forEach(childElement => object.appendChild((childElement as ObjectMethodBox).Methods.Create()));
