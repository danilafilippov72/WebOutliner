            ...
            public static MouseHandler = class MouseHandler {
                ...
                public static HoverIn = class HoverIn {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Run(Information) {
                            if (CurrentMethod.Response && OtherMethods.length > 0) HoverIn.OtherMethods[CurrentMethod.MethodIndex](Information.properties, Information.Identificator);
                        }
                ...
                public static HoverOut = class HoverOut {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Information) {
                            if (CurrentMethod.Response && OtherMethods.length > 0) HoverOut.OtherMethods[CurrentMethod.MethodIndex](Information.properties, Information.Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static HoverOver = class HoverOver {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Information) {
                            if (CurrentMethod.Response && OtherMethods.length > 0) HoverOver.OtherMethods[CurrentMethod.MethodIndex](Information.properties, Information.Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClick = class LeftClick {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Information) {
                            if (CurrentMethod.Response && OtherMethods.length > 0) LeftClick.OtherMethods[CurrentMethod.MethodIndex](Information.properties, Information.Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClickHolding = class LeftClickHolding {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Information) {
                            if (CurrentMethod.Response && OtherMethods.length > 0) LeftClickHolding.OtherMethods[CurrentMethod.MethodIndex](Information.properties, Information.Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
