                    ...
                    class Mouse {
                        public static async Initialize() {
                            (await InformationHandler.Element.References.simillarObjects).forEach(element => {
                                ...
                                element.References.htmlElement.onmousedown = (event: Event) => Mouse.onEvent(event, Mouse.eventTypes.onMouseDown);
                                element.References.htmlElement.onmouseup = (event: Event) => Mouse.onEvent(event, Mouse.eventTypes.onMouseUp);
                                        ...
                                        switch (this.onMouseDown) {
                                            case this.onMouseTypes.first: {
                                                ...
                                                this.setTimeOut(this.event, Mouse.LeftClickHolding.LeftClickHoldingDelay, () => {
                                                    ...
                                                    MouseHandler.LeftClickHolding.CurrentMethod.Run();
                                                });
                                            } break;
