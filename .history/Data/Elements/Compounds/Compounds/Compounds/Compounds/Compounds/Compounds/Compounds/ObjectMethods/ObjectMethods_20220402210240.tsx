...
export class ObjectMethods {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ObjectMethods.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            object.setAttribute("InstanceIdentificator", ObjectMethods.InstanceIdentificator);
            object = ObjectMethods.Form.Image.ApplyImage(object);
            if (ObjectMethods.Form.Image.Text != null) object.appendChild(document.createTextNode(ObjectMethods.Form.Image.Text));
            Object.values(ObjectMethods.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as ObjectMethods).Methods.Create()));
    ...
    public Image = ObjectMethods.Form;
    public Methods = ObjectMethods.Methods;
    public Elements = ObjectMethods.Elements;
    public References = ObjectMethods.References;
    //#endregion
    //#endregion Hidden
}