import { Node } from "../Compounds/Compounds/Compounds/Compounds/Node/Node";
...
export class AddNode {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static MouseHandler = class MouseHandler {
                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        async function (Identificator, Properties) {
                            document.querySelector('[identificator="' + Identificator + '"]').parentElement.parentElement.appendChild((await Node.Methods.Create()));
                            (global.search.FindObjectByIdentificator( document.querySelector('[identificator="' + Identificator + '"]').parentElement.getAttribute("identificator"), global.Doc) as AddNode).Methods.InformationHandler.ExtensionLackListeners();
                            //console.log((global.search.FindObjectByIdentificator(Identificator, global.Doc) as AddNode).Identificator);
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(AddNode.Elements).forEach(childElement => { console.log(childElement); childElement.Methods.InformationHandler.ExtensionLackListeners() });
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            AddNode.Identificator = global.count.toString();
            if (AddNode.InstanceIdentificator == null) AddNode.InstanceIdentificator = count.toString();
            ...
            if (AddNode.Form.Image.Text != null) object.appendChild(document.createTextNode(AddNode.Form.Image.Text));

            Object.values(AddNode.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as AddNode).Methods.Create());
            });
    ...
    public Image = AddNode.Form;
    public Methods = AddNode.Methods;
    public Elements = AddNode.Elements;
    public References = AddNode.References;
    //#endregion
    //#endregion Hidden
}