...
class Search {
    public static FindObjectByIdentificator(Identificator, object) {
        //console.log("Need to find: ", Identificator);
        console.log(Identificator, Number((object as typeof Document).name),   (object as typeof Document).Identificator);
        if (Number((object as typeof Document).Identificator) == Number(Identificator)) return object
        else
            return Search.FindObjectByIdentificator(Identificator, Object.values(object.Elements)
            .find(childObject => Number(Identificator) <= Number((childObject as typeof Document).Identificator)))
           /*  
