export class OutlineHor {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static MouseHandler = class MouseHandler {
                ...
                public static HoverIn = class HoverIn {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Run() {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverIn.OtherMethods[CurrentMethod.MethodIndex]();
                        }
                ...
                public static HoverOut = class HoverOut {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run() {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverOut.OtherMethods[CurrentMethod.MethodIndex]();
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static HoverOver = class HoverOver {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run() {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverOver.OtherMethods[CurrentMethod.MethodIndex]();
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClick = class LeftClick {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run() {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) LeftClick.OtherMethods[CurrentMethod.MethodIndex]();
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClickHolding = class LeftClickHolding {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run() {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) LeftClickHolding.OtherMethods[CurrentMethod.MethodIndex]();
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(OutlineHor.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (OutlineHor.Form.Image.Text != null) object.appendChild(document.createTextNode(OutlineHor.Form.Image.Text));
            Object.values(OutlineHor.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as OutlineHor).Methods.Create()));
    ...
    public Image = OutlineHor.Form;
    public Methods = OutlineHor.Methods;
    public Elements = OutlineHor.Elements;
    public References = OutlineHor.References;
    //#endregion
    //#endregion Hidden
}