    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static ApplyImage(element: HTMLDivElement) {
                ...
                if (Image.Border?.maxHeight != null) element.style.maxHeight = (typeof Image.Border.boxSizing == typeof String ? Image.Border.maxHeight as string : (Image.Border?.maxHeight + "px"));
