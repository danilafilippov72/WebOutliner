export class ObjectMethodsText {
    ...
    public static Methods = class Methods {
        ...
        public static async Create(count: number): Promise<[HTMLDivElement, number]> {
            var count = count;
            ObjectMethodsText.Identificator = count.toString();
            ...
            const array = Object.values(ObjectMethodsText.Elements);
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                const t = await (childElement as ObjectMethodsText).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
