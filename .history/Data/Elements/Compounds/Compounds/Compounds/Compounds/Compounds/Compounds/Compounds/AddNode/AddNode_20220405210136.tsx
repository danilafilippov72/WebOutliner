                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        async function (Identificator, Properties) {
                            ...
                            (global.search.FindObjectByIdentificator( document.querySelector('[identificator="' + Identificator + '"]').parentElement, global.Doc) as AddNode).Methods.InformationHandler.ExtensionLackListeners();
