export class OutlineVertical {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridArea: string /* = [1,1] */ = "c";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(OutlineVertical.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (OutlineVertical.Form.Image.Text != null) object.appendChild(document.createTextNode(OutlineVertical.Form.Image.Text));
            Object.values(OutlineVertical.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as OutlineVertical).Methods.Create()));
    ...
    public Image = OutlineVertical.Form;
    public Methods = OutlineVertical.Methods;
    public Elements = OutlineVertical.Elements;
    public References = OutlineVertical.References;
    //#endregion
    //#endregion Hidden
}