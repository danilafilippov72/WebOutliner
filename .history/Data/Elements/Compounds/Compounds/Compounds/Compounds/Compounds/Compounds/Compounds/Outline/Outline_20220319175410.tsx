export class Outline {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridArea: any /* = [1,1] */ = "a";
    ...
    public static Methods = class Methods {
        ...
        public static Create() {
            ...
            object.setAttribute("Identificator", Outline.Identificator);
            ...
            Object.values(Outline.Elements).forEach(childElement => object.appendChild((childElement as Outline).Methods.Create()));
