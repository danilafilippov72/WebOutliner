export class OutlineHor {
    ...
    public static Methods = class Methods {
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            object.setAttribute("Identificator", OutlineHor.Identificator);
            ...
            Object.values(OutlineHor.Elements).forEach(childElement => object.appendChild((childElement as OutlineHor).Methods.Create()));
