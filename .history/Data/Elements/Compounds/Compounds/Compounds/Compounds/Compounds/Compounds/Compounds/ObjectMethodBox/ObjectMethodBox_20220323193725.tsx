...
export class ObjectMethodBox {
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<[HTMLDivElement]> {
            var count = count;
            ObjectMethodBox.Identificator = count.toString();
            ...
            const array = Object.values(ObjectMethodBox.Elements);
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                const t = await (childElement as ObjectMethodBox).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
