                ...
                public static LeftClick = class LeftClick {
                    ...
                    private static OtherMethods: Function[] = [
                        async function (Identificator, Properties) {
                            ...
                            consolke.log('iopiopiopiop', document.querySelector('[identificator="' + Identificator + '"]').parentElement.getAttribute("identificator"))
                            ...
                            object.Methods.InformationHandler.ExtensionLackListeners();
