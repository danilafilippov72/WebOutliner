export class ObjectMethodsText {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "Methods";
            ...
            public static gridArea: any /* = [1,1] */ = "b";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ObjectMethodsText.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ObjectMethodsText.InstanceIdentificator == null) ObjectMethodsText.InstanceIdentificator = count.toString();
            ...
            if (ObjectMethodsText.Form.Image.Text != null) object.appendChild(document.createTextNode(ObjectMethodsText.Form.Image.Text));

            Object.values(ObjectMethodsText.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as ObjectMethodsText).Methods.Create()));
    ...
    public Image = ObjectMethodsText.Form;
    public Methods = ObjectMethodsText.Methods;
    public Elements = ObjectMethodsText.Elements;
    public References = ObjectMethodsText.References;
    //#endregion
    //#endregion Hidden
}