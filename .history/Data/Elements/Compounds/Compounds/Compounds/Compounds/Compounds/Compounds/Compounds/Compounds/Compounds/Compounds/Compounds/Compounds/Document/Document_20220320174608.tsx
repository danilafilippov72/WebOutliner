...
export class Document {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static MouseHandler = class MouseHandler {
                public static async Initialize(Information) {
                    MouseHandler[Information.Method].CurrentMethod.Run(Information.properties);
                }
                ...
                public static HoverIn = class HoverIn {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Run(event) {
                            if (CurrentMethod.Response) HoverIn.OtherMethods[CurrentMethod.MethodIndex](event);
                        }
                ...
                public static HoverOut = class HoverOut {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(event) {
                            if (CurrentMethod.Response) HoverOut.OtherMethods[CurrentMethod.MethodIndex](event);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static HoverOver = class HoverOver {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(event) {
                            if (CurrentMethod.Response) HoverOver.OtherMethods[CurrentMethod.MethodIndex](event);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
        ...
        public static async Create(count: number): Promise<[HTMLDivElement, number]> {
            ...
            const array = Object.values(Document.Elements);
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                const t = await (childElement as Document).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
        ...
        public static async Init() {
            document.body.append((await Document.Methods.Create(1))[0]);
            ...
            document.body.onmouse = (ev) => Document.Methods.InformationHandler.Initialize({
                ObjectReference: "MouseHandler",
                Method: "HoverOut",
                properties: ev
            });
                            ...
                            case this.eventTypes.onMouseDown: {
                                switch (this.onMouseDown) {
                                    case this.onMouseTypes.first: {
                                        ...
                                        this.setTimeOut(this.event, 300, () => {
                                            this.isHolding = true;
                                ...
                                switch (this.onMouseUp) {
                                    case this.onMouseTypes.first: {
                                        ...
                                        if (this.isHolding) {
                                            ...
                                            this.setTimeOut(this.event, /* Mouse.LeftDoubleClick.LeftDoubleClickDelay */ 300, (event) => {
                                                this.setOnMouseDown(this.onMouseTypes.first);
                                                this.setNextOnMouseUp(this.onMouseTypes.first);
                                                Document.Methods.InformationHandler.Initialize({
                                                    ObjectReference: "MouseHandler",
            ...
            Document.Elements.MethodsNode.Methods.InformationHandler.ExtensionLackListeners();
        };
    }
