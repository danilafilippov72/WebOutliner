...
export class ElementCreator {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = '"a b b b c" 0 "d e e e f" auto "d g h i f" auto "d j j j f" auto "k l l l m" auto / auto auto auto auto auto';
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static MouseHandler = class MouseHandler {
                ...
                public static HoverIn = class HoverIn {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Run(Identificator, Properties) {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverIn.OtherMethods[CurrentMethod.MethodIndex](Identificator);
                        }
                ...
                public static HoverOut = class HoverOut {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Identificator, Properties) {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverOut.OtherMethods[CurrentMethod.MethodIndex](Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static HoverOver = class HoverOver {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Identificator, Properties) {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) HoverOver.OtherMethods[CurrentMethod.MethodIndex](Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClick = class LeftClick {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Identificator, Properties) {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) LeftClick.OtherMethods[CurrentMethod.MethodIndex](Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                ...
                public static LeftClickHolding = class LeftClickHolding {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = true;
                        public static Run(Identificator, Properties) {
                            if (CurrentMethod.Response && LeftClickHolding.OtherMethods.length > 0) LeftClickHolding.OtherMethods[CurrentMethod.MethodIndex](Identificator);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(ElementCreator.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (ElementCreator.InstanceIdentificator == null) ElementCreator.InstanceIdentificator = count.toString();
            ...
            if (ElementCreator.Form.Image.Text != null) object.appendChild(document.createTextNode(ElementCreator.Form.Image.Text));

            Object.values(ElementCreator.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as ElementCreator).Methods.Create()));
    ...
    public static Elements = class Elements {
        public static ElementPaddingTop = ElementPaddingTop;
        public static ElementPaddingLeft = ElementPaddingLeft;
    ...
    public Image = ElementCreator.Form;
    public Methods = ElementCreator.Methods;
    public Elements = ElementCreator.Elements;
    public References = ElementCreator.References;
    //#endregion
    //#endregion Hidden
}