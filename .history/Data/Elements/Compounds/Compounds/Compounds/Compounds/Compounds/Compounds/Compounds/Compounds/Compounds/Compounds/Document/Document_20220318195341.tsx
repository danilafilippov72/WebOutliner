                ...
                public static Initialize(Method) {
                    ...
                    class MouseHandler {
                        public static async Initialize() {
                            (await InformationHandler.Element.References.simillarObjects).forEach(element => {
                                element.Image.Image.Events = "all";
                                element.References.htmlElement.onmousedown = (event: Event) => MouseHandler.onEvent(event, MouseHandler.eventTypes.onMouseDown);
                                element.References.htmlElement.onmouseup = (event: Event) => MouseHandler.onEvent(event, MouseHandler.eventTypes.onMouseUp);
                                
                                element.References.htmlElement.onmouseenter = () => Mouse.HoverIn.Run();
                                element.References.htmlElement.onmouseleave = () => Mouse.HoverOut.Run();
                            });
                        }
                        ...
                        private static onMouseDown: string = MouseHandler.onMouseTypes.first;
                        private static setOnMouseDown(onMouseDown: string) { this.onMouseDown = onMouseDown; }
                
                        private static onMouseUp: string = MouseHandler.onMouseTypes.first;
                        ...
                        static onEvent(event: Event, mouseEvent: typeof MouseHandler.eventTypes[keyof typeof MouseHandler.eventTypes]  /* type typesOf<T> = T[keyof T]; */) {
                                    ...
                                    case this.eventTypes.onMouseDown: {
                                        switch (this.onMouseDown) {
                                            case this.onMouseTypes.first: {
                                                ...
                                                this.setTimeOut(this.event, Mouse.LeftClickHolding.LeftClickHoldingDelay, () => {
                                                    this.isHolding = true;
                                                    this.setOnMouseDown(this.onMouseTypes.first);
                                                    this.setNextOnMouseUp(this.onMouseTypes.first);
                                                    Mouse.LeftClickHolding.Run();
                                                });
                                            } break;
                                        ...
                                        switch (this.onMouseUp) {
                                            case this.onMouseTypes.first: {
                                                ...
                                                if (this.isHolding) {
                                                    ...
                                                    this.setTimeOut(this.event, Mouse.LeftDoubleClick.LeftDoubleClickDelay, (event) => {
                                                        this.setOnMouseDown(this.onMouseTypes.first);
                                                        this.setNextOnMouseUp(this.onMouseTypes.first);
                                                        Mouse.LeftClick.Run();
