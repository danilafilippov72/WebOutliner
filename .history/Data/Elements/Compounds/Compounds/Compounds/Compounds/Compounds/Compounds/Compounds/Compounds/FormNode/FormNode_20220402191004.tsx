...
export class FormNode {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static gridTemplate: string = ' "a b" auto "c d" auto / auto auto ';
            public static Display: "none" | "block" | "grid" = "grid";
            public static gridTemplateColumns: string /* = "10% 90%" */;
            public static gridArea: string /* = [1,1] */ = "e";
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            Object.values(FormNode.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as FormNode).Methods.Create()));
