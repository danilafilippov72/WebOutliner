...
export class WindowForm {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(WindowForm.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (WindowForm.InstanceIdentificator == null) WindowForm.InstanceIdentificator = count.toString();
            ...
            if (WindowForm.Form.Image.Text != null) object.appendChild(document.createTextNode(WindowForm.Form.Image.Text));

            Object.values(WindowForm.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as WindowForm).Methods.Create()));
    ...
    public Image = WindowForm.Form;
    public Methods = WindowForm.Methods;
    public Elements = WindowForm.Elements;
    public References = WindowForm.References;
    //#endregion
    //#endregion Hidden
}