                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                const imageObject = (document.querySelector('[identificator="' + Identificator + '"]') as HTMLDivElement).parentElement;
                                const object = global.search.FindObjectByIdentificator(imageObject.getAttribute("identificator")) 
