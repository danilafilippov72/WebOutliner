                        ...
                        function (Identificator, Properties, Object) {
                            ...
                            if (global?.Coordinates != null) {
                                global.search.FindObjectByIdentificator(
                                    (document.querySelector('[identificator="' + Identificator + '"]') as HTMLDivElement).parentElement.getAttribute("identificator")) 
                                    .Form.Image.gridRowsWidth[0] += global.Coordinates.x - Properties.Coordinates.x;
                                    =  + "px auto auto auto auto";
                            }
                            global.Coordinates = {
