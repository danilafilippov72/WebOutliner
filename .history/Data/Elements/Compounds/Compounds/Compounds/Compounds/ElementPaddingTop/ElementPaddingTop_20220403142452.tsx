                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties, Object) {
                            ...
                            if (global?.Coordinates != null) {
                                (global.search.FindObjectByIdentificator((document.querySelector('[identificator="' + Identificator + '"]') as HTMLDivElement).parentElement.getAttribute("identificator")) as typeof ElementPaddingTop);
