                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                const object = globalThis.search.FindObjectByIdentificator(imageObject.getAttribute("identificator"), Document) as unknown as typeof ElementPaddingTop;
                                console.log(object)
                                object.Form.Image.gridRowsWidth[0] += global.Coordinates.x - Properties.Coordinates.x;
                                object.Form.Image.ApplyImage(imageObject);
