                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                const object = global.search.FindObjectByIdentificator((document.querySelector('[identificator="' + Identificator + '"]') as HTMLDivElement).parentElement.getAttribute("identificator")) 
