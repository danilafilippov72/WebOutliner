...
export class ElementPaddingTop {
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            public static Initialize(Information, Object) {
                InformationHandler[Information.ObjectReference].Initialize(Information, Object);
            } t

            public static MouseHandler = class MouseHandler {
                public static Initialize(Information, Object) {
                    MouseHandler[Information.Method].CurrentMethod.Run(Information.Identificator, Information.Properties, Object);
                }
                ...
                public static LeftClickHolding = class LeftClickHolding {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Run(Identificator, Properties, Object) {
                            if (CurrentMethod.Response) LeftClickHolding.OtherMethods[CurrentMethod.MethodIndex](Identificator, Properties, Object);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties, Object) {
                            console.log("Holddd")
                ...
                public static Move = class Move {
                    public static CurrentMethod = class CurrentMethod {
                        ...
                        public static Response: boolean = false;
                        public static Run(Identificator, Properties, Object) {
                            if (CurrentMethod.Response) Move.OtherMethods[CurrentMethod.MethodIndex](Identificator, Properties, Object);
                        }
                        public static Set(MethodIndex: number) {
                            CurrentMethod.MethodIndex = MethodIndex;
                        }
                    ...
                    private static OtherMethods: Function[] = [
                        function (Identificator, Properties) {
                            ...
                            if (global?.Coordinates != null) {
                                ...
                                var object = globalThis.search.FindObjectByIdentificator(imageObject.getAttribute("identificator"), Document) as unknown as typeof ElementPaddingTop;
                                console.log(object)
                                object.Form.Image.gridRowsWidth[0] += global.Coordinates.x - Properties.Coordinates.x;
                                object.Form.Image.ApplyImage(ref imageObject);
                                //imageObject.style.gridTemplateRows =
                            }
                            global.Coordinates = {
                ...
                if (InformationHandler.isListener == false) {
                    ...
                    document.querySelectorAll('[instanceidentificator="' + ElementPaddingTop.InstanceIdentificator + '"]')
                        .forEach(element => element.addEventListener(
                            "Outline",
                            function (event: CustomEvent) { InformationHandler.Initialize(event.detail, ElementPaddingTop) }
                        ));
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            Object.values(ElementPaddingTop.Elements).forEach(async childElement => {
                global.count += 1;
                (childElement as typeof global.Doc).Identificator = global.count.toString(); object.appendChild(await (childElement as ElementPaddingTop).Methods.Create());
            });
