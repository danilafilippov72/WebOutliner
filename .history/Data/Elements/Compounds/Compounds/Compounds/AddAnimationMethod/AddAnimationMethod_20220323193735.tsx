export class AddAnimationMethod {
    ...
    public static Methods = class Methods {
        ...
        public static async Create(): Promise<[HTMLDivElement]> {
            global.count += 1;
            AddAnimationMethod.Identificator = count.toString();
            ...
            const array = Object.values(AddAnimationMethod.Elements);
            for (let index = 0; index < array.length; index++) {
                const childElement = array[index];
                const t = await (childElement as AddAnimationMethod).Methods.Create(count + 1);
                const child = t[0];
                const countAdd = t[1];
