...
export class AddAnimationMethod {
    ...
    public static Form = class Form {
        ...
        public static Image = class Image {
            ...
            public static Text: string = "AddAnimationMethod";
    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                ...
                Object.values(AddAnimationMethod.Elements).forEach(childElement => childElement.Methods.InformationHandler.ExtensionLackListeners());
            }
            //#endregion Hidden
        };
        ...
        public static async Create(): Promise<HTMLDivElement> {
            ...
            if (AddAnimationMethod.InstanceIdentificator == null) AddAnimationMethod.InstanceIdentificator = count.toString();
            ...
            if (AddAnimationMethod.Form.Image.Text != null) object.appendChild(document.createTextNode(AddAnimationMethod.Form.Image.Text));

            Object.values(AddAnimationMethod.Elements).forEach(async childElement =>
                object.appendChild(await (childElement as AddAnimationMethod).Methods.Create()));
    ...
    public Image = AddAnimationMethod.Form;
    public Methods = AddAnimationMethod.Methods;
    public Elements = AddAnimationMethod.Elements;
    public References = AddAnimationMethod.References;
    //#endregion
    //#endregion Hidden
}