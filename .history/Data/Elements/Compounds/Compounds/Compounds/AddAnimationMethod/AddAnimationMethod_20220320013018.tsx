export class AddAnimationMethod {
    ...
    public static Methods = class Methods {
        ...
        public static Create(count: number): [HTMLDivElement, number] {
            ...
            object.setAttribute("Identificator", AddAnimationMethod.Identificator);
            ...
            Object.values(AddAnimationMethod.Elements).forEach(childElement => object.appendChild((childElement as AddAnimationMethod).Methods.Create()));
