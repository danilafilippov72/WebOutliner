    ...
    public static Methods = class Methods {
        public static InformationHandler = class InformationHandler {
            ...
            public static ExtensionLackListeners() {
                console.log("SpaceMethods, ", OtherMethods.Elements.SpaceMethods.Identificator, OtherMethods.Elements.SpaceMethods.InstanceIdentificator);
                //console.log("SpaceMethods, ", OtherMethods.Elements.SpaceMethods.Identificator);
        ...
        public static async Create(): Promise<HTMLDivElement> {
            global.count += 1;
            this.Identificator = global.count.toString();
            ...
            Object.values(OtherMethods.Elements).forEach(async childElement => {
                (childElement as OtherMethods).Identificator = 
        ...
        //#region Hidden
        /* public static set Identificator(Identificator: string) {
            this.pareIdentificator = Identificator;
        } */
        //#endregion Hidden
    }

    public static Elements = class Elements {
        public static SpaceMethods = class extends SpaceMethods{};
    }
